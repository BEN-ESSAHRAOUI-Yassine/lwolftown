...
Railway deployment configuration for the 3-service architecture (app, reverb, queue), production environment variable templates, HTTPS/WSS enforcement, and local development configuration.
