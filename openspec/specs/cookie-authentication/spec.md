# Cookie Authentication Specification

## Purpose
Defines cookie-based player identity using session_token UUID, AppServiceProvider guard registration, locale handling, DB protection, and broadcasting auth endpoint.
