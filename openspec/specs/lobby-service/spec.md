# Lobby Service Specification

## Purpose
Defines the LobbyService methods for creating rooms, joining rooms, and validating game start conditions, as well as the PlayerJoined event and QrHelper utility.
