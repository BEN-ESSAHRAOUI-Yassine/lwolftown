...
Laravel project scaffold with all dependencies, Vite + TailwindCSS v4 configuration, dark atmospheric CSS theme, WebSocket bootstrap, Blade layout, AppServiceProvider setup, config files, and environment templates. This is the foundational layer that all other capabilities depend on.
