...
Role image system — directory structure, placeholder SVG fallback, image file convention (1x/2x), Blade helper for srcset resolution, and card layout for revealed role images.
